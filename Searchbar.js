...
export default function Searchbar() {
  ...
  return (
    <div>
    <div className="bg-gradient-to-r from-red-500 to-red-500 h-[300px] w-full flex flex-col justify-center items-center relative">
      <div>
      ...
      <div className="mt-6 flex">
        <div className="relative">
          <input
            ...
            className="px-8 py-2 pl-10 w-[400px] rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 relative"
            value={searchQuery}
