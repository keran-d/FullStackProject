...
import bg from "../../assests/images/signup.jpg";
...
export default function SignUp() {
  ...
  <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-1/3">
    <h1 className="text-2xl font-bold mb-8 text-center text-red-500">SIGNUP</h1>
    <div className="mb-4">
      <label
    ...
    <div className="flex items-center justify-between">
      ...
      <div>
        <h6 className="mb-2 text-black-500">Already have an account?</h6>
        <button
          className="text-sm text-red-500 hover:text-blue-800 focus:outline-none"
          type="button"
          onClick={handleLogin}
        >
          Login
